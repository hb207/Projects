...
With PopVax (continent, location, date, population, new_tests, IncrementalTests, 
			people_fully_vaccinated, new_vaccinations, IncrementalVaccinations) as
(
...
Select location, population, date, IncrementalTests, 
		(cast((IncrementalTests/population)*100 as decimal (6,3))) as TestsPer100People,
